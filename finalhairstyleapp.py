...
def imageInput(src):
    ...
    if src == 'Upload your own Hairstyle Image':
        ...
        imgpath = glob.glob('C:/Users/46058007/OneDrive - MMU/Attachments/Stylebook/dataset/images/train/*') #should be the same as what the similarity algorithm was trained on
